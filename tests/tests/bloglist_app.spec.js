    ...
    describe("When logged in", () => {
      ...
      describe("When blog created", () => {
        ...
        test("a blog can be deleted", async ({ page }) => {
          ...
          await expect(deletedDiv).toContainText(
            "the blog La Odisea by Homero has been removed successfully",
          );
        ...
        test("blogs are arranged in the order according to the likes, the blog with the most likes first", async ({
          ...
          await expect(blogsDivs[0]).toContainText(
